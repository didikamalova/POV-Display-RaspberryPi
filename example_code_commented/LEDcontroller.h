...
private:
    static PIO pio;
    static uint sm;
	// array of size 2 x buffer size - essentailly defines virtual and non-virtual buffer
    static uint8_t pixel_buffer[2U][N_BUFFER_SIZE]; // 2D array 1 byte per index
    static uint8_t render_buffer_idx; // find index of rendering buffer
